...
for i in range(len(tall_buildings_adapted)):
    e = tall_buildings_adapted[i]['p']
    c = 'black'
    if tall_buildings_adapted[i]['c'] == 1:
        c = 'red'
    elif tall_buildings_adapted[i]['c'] == 2:
        c = 'green'
    elif tall_buildings_adapted[i]['c'] == 3:
        c = 'blue'
    plt.plot(e[0], e[1], marker='o', color=c)
plt.show()